...
const adminMenuItems = [
  ...
  { icon: Table, label: 'Tables & Reservations', path: '/tables', feature: 'tables' },
  { icon: Package, label: 'Menu Management', path: '/menu', feature: 'menu' },
  ...
  { icon: BarChart3, label: 'Vendor Management', path: '/vendors', feature: 'vendors' },
