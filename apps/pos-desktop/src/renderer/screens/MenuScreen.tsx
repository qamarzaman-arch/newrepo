      ...
      <div className="flex items-center justify-between">
        ...
        {isAdminOrManager && (
          activeTab === 'categories' ? (
            <button onClick={handleAddCategory} className="px-4 py-2 gradient-btn rounded-xl font-semibold flex items-center gap-2">
          ...
          {categories?.map((category: any) => (
            <div key={category.id} className="bg-surface-lowest rounded-2xl p-6 shadow-soft">
              ...
              <div className="flex gap-2">
                <button onClick={() => handleEditCategory(category)} className="flex-1 py-2 bg-blue-100 text-blue-700 rounded-lg text-sm font-semibold">
                  Edit
                </button>
                <button onClick={() => handleDeleteCategory(category.id)} className="p-2 bg-red-100 text-red-700 rounded-lg">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                onClick={modalType === 'category' ? handleSaveCategory : handleSaveItem}
